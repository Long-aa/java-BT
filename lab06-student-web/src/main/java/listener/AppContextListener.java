...
public class AppContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        StudentStore.add(new Student("SV002", "Tran Thi Binh", "DCCNTT13", "binh@example.com"));
        StudentStore.add(new Student("SV003", "Nong Quoc Dung", "DCCNTT14", "dung@example.com"));
        StudentStore.add(new Student("SV004", "Tran Thi Lan", "DCCNTT12", "lan@example.com"));
        StudentStore.add(new Student("SV005", "Le Van Cuong", "DCCNTT14", "cuong@example.com"));
